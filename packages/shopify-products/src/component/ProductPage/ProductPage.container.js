...
/**
 * A product page container, main purpose - to request the product
...
export class ProductPageContainer extends HigherOrderComponent {
    ...
    /**
     * A getter of product query arguments
     * @extPoint Inject additional arguments into product query
